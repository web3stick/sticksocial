...
- ~~`./bin`, for testing the near socail js functions~~ rm'ed because these functions are hardcoded with the near kit web client, use "https://github.com/sleet-js/near-social-tool-box" as a place to test instead
